...
function toneFor(percent: number, exhausted: boolean): {
  ...
  if (exhausted) return { bar: 'bg-[#ff453a]', dot: 'bg-[#ff453a]', label: 'text-[#ffb4ae]' }
  if (percent >= 0.8) return { bar: 'bg-[#ffb95f]', dot: 'bg-[#ffb95f]', label: 'text-[#ffd9a8]' }
  return { bar: 'bg-[#6fd393]', dot: 'bg-[#6fd393]', label: 'text-light-muted' }
}
